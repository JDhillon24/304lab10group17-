...
<form name="MyForm1" method=post action="#">
    ...
    <tr class= "spacerows">
        <td><center></center><div align="right"><font face="Arial, Helvetica, sans-serif" size="2">Warehouse Id: </div></center></td>
        <td><center><input type="text" name="wId"  id = "wId-field" class = "Product-form" size=10 maxlength=2 required></center></td>
    </tr>
    <tr class= "spacerows">
        <td><div align="right"><font face="Arial, Helvetica, sans-serif" size="2">Warehouse Name: </div></td>
