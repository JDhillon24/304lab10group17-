...
DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (4, '2019-10-17 05:45:11', 2977.00)
SELECT @orderId = @@IDENTITY
...
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, productSize, quantity, price) VALUES (@orderId, 5, 8.5, 4, 180.00) 
INSERT INTO orderproduct (orderId, productId, productSize, quantity, price) VALUES (@orderId, 19, 8.5, 2, 234.00) 
INSERT INTO orderproduct (orderId, productId, productSize, quantity, price) VALUES (@orderId, 20, 8.5, 3, 257.00); 
