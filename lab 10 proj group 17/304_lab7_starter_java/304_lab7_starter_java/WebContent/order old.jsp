...
if(Integer.parseInt(custId) < 1 || Integer.parseInt(custId) > 5) {
	...
	{	
		...
		String sql4 = "SELECT orderProduct.productId AS productId, productName, quantity, price, (quantity*price) AS subtotal, productSize FROM product JOIN orderProduct ON product.productId = orderProduct.productId WHERE orderId = " + orderId;
		...
		while (rst2.next()) {
			out.println("<tr><td>"+rst2.getInt(1)+"</td>"+"<td>"+rst2.getString(2)+"</td>"+"<td>"+rst2.getString(6)+"</td>"+"<td>"+rst2.getInt(3)+"</td>"+"<td>"+currFormat.format(rst2.getDouble(4))+"</td>"+"<td>"+currFormat.format(rst2.getDouble(5))+"</td></tr>");
		}
