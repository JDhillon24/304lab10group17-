...
<form name="MyForm1" method=post action="validateLogin.jsp">
    ...
    <tr>
        <td><center><div align="right"><font face="Arial, Helvetica, sans-serif" size="2">Shoe Name: </div></center></td>
        <td><input type="text" name="pname"  id = "pname-field" class = "Product-form" size=10 maxlength=10></td>
    </tr>
    <tr>
